...
START TRANSACTION;
USE `service`;
INSERT INTO `service`.`HasA` (`belongsToID`, `deviceID`, `personID`, `roomID`) VALUES (1, 1, 1, NULL);
INSERT INTO `service`.`HasA` (`belongsToID`, `deviceID`, `personID`, `roomID`) VALUES (2, 2, NULL, 1);
